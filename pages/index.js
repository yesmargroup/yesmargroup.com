...
<div>
        ...
        <div id="post">
          <section className="py-5">
            <div className="container">
              {/* Buttons */}
              <div id="content"> <p>Mandate: Provide exceptional returns through investing in publicly traded growth technology stocks for long-term capital appreciation and short-term gains when appropriate through event-driven strategies.</p></div>
              <h6>Updated: April-18-2020</h6>
            </div>
            <div className="container">
              <img src="images/Thesis-1.JPG" style={{width: '100%'}} />
              <img src="images/Thesis-2.JPG" style={{width: '100%'}} />
            </div>
          </section></div>
        {/* END Mandate */}
        {/* START Post Content */}
        <div id="post">
          <section className="py-5">
            <div className="container">
              <h2 className="font-weight-light">Airbnb Pre-IPO Key Takeaways</h2>
              <div id="content">
                <h6>Dec-4-2020</h6>
              </div>
              <img src="images/ABNB-Airbnb-Profile-v12.04.2020.jpg" style={{width: '100%'}} />
              <div id="content"> 
          ...
          <div id="post">
            <section className="py-5">
              <div className="container">
                <h2 className="font-weight-light">Institutional Ownership</h2>
                <div id="content">
                  <h6>Dec-3-2020</h6>
                </div>
                <img src="images/Institutional-Holders-v12.3.2020.jpg" style={{width: '100%'}} />
                <div id="content"> 
            ...
            <div id="post">
              <section className="py-5">
                <div className="container">
                  <h2 className="font-weight-light">Going Beyond...</h2>
                  <div id="content">
                    <h6>Nov-31-2020</h6>
                  </div>
                  <img src="images/BYND-Beyond-Meat-Profile.jpg" style={{width: '100%'}} />
                  <div id="content"> 
              ...
              <div id="post">
                <section className="py-5">
                  <div className="container">
                    <h2 className="font-weight-light">The October 2019 PG&amp;E Trade Summary</h2>
                    <div id="content">
                      <h6>Nov-8-2020</h6>
                    </div>
                    <img src="images/PGE.jpg" style={{width: '100%'}} />
                    <div id="content"> 
                ...
                <div id="post">
                  <section className="py-5">
                    <div className="container">
                      <h2 className="font-weight-light">Super Size Me ... Or Maybe Not?</h2>
                      <div id="content">
                        <h6>September-7-2020</h6>
                      </div>
                      <img src="images/The-Burger-Industry.JPG.jpg" style={{width: '100%'}} />
                      <div id="content"> 
                  ...
                  <div id="post">
                    <section className="py-5">
                      <div className="container">
                        <h2 className="font-weight-light">Old World Boeing Is Now New World Amazon</h2>
                        <div id="content">
                          <h6>August-3-2020</h6>
                        </div>
                        <img src="images/Technology-Has-Become-Defensive.jpg" style={{width: '100%'}} />
                        <div id="content"> 
                    ...
                    <div id="post">
                      <section className="py-5">
                        <div className="container">
                          <h2 className="font-weight-light">Q2-2020 Portfolio Update</h2>
                          <div id="content">
                            <h6>July-21-2020</h6>
                          </div>
                          <img src="images/Q2-2020-Perf-1.JPG" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-2.JPG" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-3.jpg" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-4.JPG" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-5.JPG" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-6.JPG" style={{width: '100%'}} />
                          <img src="images/Q2-2020-Perf-7.jpg" style={{width: '100%'}} />
                          <div id="content"> 
                      ...
                      <div id="post">
                        <section className="py-5">
                          <div className="container">
                            <h2 className="font-weight-light">Working Price-Weighted Mana Index</h2>
                            <div id="content">
                              <h6>May-24-2020</h6>
                            </div>
                            <img src="images/MANA-Price-Weighted-Index.jpg" style={{width: '100%'}} />
                        ...
                        <div id="post">
                          <section className="py-5">
                            <div className="container">
                              <h2 className="font-weight-light">Unpopular Opinion: Technology Is A Tool, Not A Business Model</h2>
                              <div id="content">
                                <h6>May-23-2020</h6>
                              </div>
                              <img src="images/Technology-Is-A-Tool.jpg" style={{width: '100%'}} />
                          ...
                          <div id="post">
                            <section className="py-5">
                              <div className="container">
                                <h2 className="font-weight-light">Working Mana Dilligence Checklist</h2>
                                <div id="content">
                                  <h6>May-22-2020</h6>
                                </div>
                                <img src="images/Dilligence-Checklist.jpg" style={{width: '100%'}} />
                            ...
                            <div id="post">
                              <section className="py-5">
                                <div className="container">
                                  <h2 className="font-weight-light">New Investment Opportunities Among Covid-19 (1/2)</h2>
                                  <div id="content">
                                    <h6>May-16-2020</h6>
                                  </div>
                                  <img src="images/Q2-20-Opp1.JPG" style={{width: '100%'}} />
                                  <img src="images/Q2-20-Opp2.JPG" style={{width: '100%'}} />
                                  <img src="images/Q2-20-Opp3.JPG" style={{width: '100%'}} />
                                  <div id="content"> 
                              ...
                              <div id="post">
                                <section className="py-5">
                                  <div className="container">
                                    <h2 className="font-weight-light">What Will The Future Of Investment Banking Look Like?</h2>
                                    <div id="content">
                                      <h6>April-22-2020</h6>
                                    </div>
                                    <img src="images/IB-revenues.jpg" style={{width: '100%'}} />
                                    <div id="content"> <p>With interest rates at record low levels, the question for managers arise: Buy, Build or Partner? This then raises another question: How will we fund the choice we make? Through Debt or Equity? If you ask a Boutique Bank, a majority of their answers will point towards equity as they don't have a debt desk and look towards the advisory fee. So then for managers, they must decide: hire a boutique bank with sector expertise and thought leadership? Or hire a full-service bulge bracket bank that can provide staple financing - if needed. Of course this is simplifying the process, but the point still stands.</p>
                                      ...
                                      <img src="images/Investment-banking2-2019.png" style={{width: '100%'}} />
                                ...
                                <div id="post">
                                  <section className="py-5">
                                    <div className="container">
                                      <h2 className="font-weight-light">2020 Is Looking To Be A Lost Year</h2>
                                      <div id="content">
                                        <h6>April-20-2020</h6>
                                      </div>
                                      <img src="images/Mar-2020-Q1-Performance-Market-Update.png" style={{width: '100%'}} />
                                  ...
                                  <div id="post">
                                    <section className="py-5">
                                      <div className="container">
                                        <h2 className="font-weight-light">Virgin Galactic Is Speaheading Commercial Space Travel For The Masses</h2>
                                        <div id="content">
                                          <h6>April-18-2020</h6>
                                        </div>
                                        <img src="images/SPCE-One-Page-vF.png" style={{width: '100%'}} />
                                        <div id="content"> <p>Virgin Galactic is an interesting play because they fit right into this lens I'm trying to analyze industrial companies in: High Margin, Technologically Advanced, American Manufacturing with prominent leadership – Virgin has all of this. This business is reminiscent of Tesla in the early days. We entered this investment around February and have been taking hits from their speculation as well as the damper from the CoronaVirus. 
                                          </p><p>With respect to their TAM and opening this up to the masses, I feel there is a fundamental business of selling the space experience here. $250k is not that much to spend on a one in a lifetime event like this. Imagine a Kardashian live streaming from space, or someone live streaming the first trade from space, the first MMA fight from space etc..</p> 
                                    ...
                                    <div id="post">
                                      <section className="py-5">
                                        <div className="container">
                                          <h2 className="font-weight-light">Real-Time Vertical Integration Enables Extreme Moats, With Monopolistic-Like Market Structures</h2>
                                          <div id="content">
                                            <h6>April-17-2020</h6>
                                          </div>
                                          <img src="images/Social-Digital-Media-Landscape.png" style={{width: '100%'}} />
                                      ...
                                      <div id="post">
                                        <section className="py-5">
                                          <div className="container">
                                            <h2 className="font-weight-light">An Analysis of the Whole Foods / Amazon Business Combination</h2>
                                            <div id="content">
                                              <h6>March-30-2020</h6>
                                            </div>
                                            <img src="images/WFAM-1.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-2.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-3.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-4.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-5.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-6.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-7.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-8.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-9.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-10.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-12.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-13.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-14.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-15.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-16.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-17.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-18.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-19.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-20.JPG" style={{width: '100%'}} />
                                            <img src="images/WFAM-21.JPG" style={{width: '100%'}} />
                                      ...
                                      <div id="post">
                                        <section className="py-5">
                                          <div className="container">
                                            <h2 className="font-weight-light">Feburary 2020 Market Update: COVID-19</h2>
                                            <div id="content">
                                              <h6>Feburary-29-2020</h6>
                                            </div>
                                            <img src="images/Feb-2020-Market-Update-Correction.png" style={{width: '100%'}} />
                                          ...
                                          <div id="post">
                                            <section className="py-5">
                                              <div className="container">
                                                <h2 className="font-weight-light">The Streaming Wars: A Spotify / Apple Business Combination</h2>
                                                <div id="content">
                                                  <h6>October-27-2020</h6>
                                                </div>
                                                <img src="images/SPOT-APPL1.JPG" style={{width: '100%'}} />
                                                <img src="images/SPOT-APPL2.JPG" style={{width: '100%'}} />
